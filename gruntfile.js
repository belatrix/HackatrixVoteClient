...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    htmlbuild: {
        ...
        distro: {
            src: 'template/distro/index.html',
            dest: 'distro/',
            options: {
                scripts: {
                    bundle: [
    ...
    concat: {
      css:{
        src: ['source/css/attach.css',
              'source/css/**/*.css'],
        dest: 'distro/css/'+ project.name +'-'+project.version+'.css'
      ...
      js:{
        src:['source/lib/angular.js',
            'source/lib/**/*.js',
            'source/scripts/**/*.js'],
        dest:'distro/js/'+ project.name +'-' + project.version + '.js'
      }
    },
    ...
    compress: {
      distro: {
        options: {
          archive: 'export/'+ project.name +'-'+project.version+'.zip'
        },
        expand: true,
        cwd: 'distro',
        src: ['**']
